...
public sealed class NotePdfExportOptions
{
    ...
    /// and <c>{1}</c> for the total. The caller passes its own translation so a Norwegian note does not
    /// print English footers; the literal parts are escaped into the Typst pattern.
    /// </summary>
