...
/// <summary>
/// Schema v2 mindmap service (see <see cref="IMindmapDocumentService"/>). It is the single command layer:
...
/// </summary>
public sealed class MindmapDocumentService : IMindmapDocumentService
{
