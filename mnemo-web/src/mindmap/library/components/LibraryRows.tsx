...
import { DueBadge, MapMenuItems } from "./MapCard"
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-3 top-1/2 -translate-y-1/2">
        <CardMenuButton label={mm("FolderActions")} className={MENU_CLASS}>
...
export function MapRow({
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-3 top-1/2 -translate-y-1/2">
        <CardMenuButton label={mm("MapActions")} className={MENU_CLASS}>
