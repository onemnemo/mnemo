...
import { useTransfer, type TransferTarget } from "./store"
import {
...
export function TransferOverlay() {
  ...
  return <Transfer target={target} onClose={close} />
}

type Direction = "import" | "export"

function Transfer({ target, onClose }: { target: TransferTarget; onClose: () => void }) {
  const t = useT()
