...
export const ERROR_KEYS: Readonly<Record<string, string>> = {
  ...
  backup_manifest_missing: "BackupInvalid",
  backup_manifest_invalid: "BackupInvalid",
  backup_format_unsupported: "BackupInvalid",
  backup_version_unsupported: "BackupInvalid",
  backup_version_newer: "BackupNewer",
  backup_app_newer: "BackupNewer",
  backup_duplicate_path: "BackupUnsafe",
  backup_path_unsafe: "BackupUnsafe",
  backup_directory_entry: "BackupUnsafe",
  backup_link_rejected: "BackupUnsafe",
  backup_unknown_file: "BackupUnsafe",
  backup_too_large: "BackupTooLarge",
  backup_too_many_files: "BackupTooLarge",
  ...
  backup_checksum_failed: "BackupDamaged",
  backup_failed: "BackupFailed",
  restore_stage_failed: "RestoreFailed",
  restore_recovery_pending: "RestoreRecoveryPending",
  restore_not_staged: "BackupSelectionLapsed",
  restart_unavailable: "RestartUnavailable",
  unknown_backup_grant: "BackupSelectionLapsed",
  profile_backup_requires_restore: "ProfileBackupRequiresRestore",
}
