...
| [03-dotnet.md](standards/03-dotnet.md) | C#, async and cancellation, errors, lifecycle, MVVM and Avalonia |
...
1. Architecture boundaries are strict: `Mnemo.Core` holds interfaces and models with zero
   ...
   serves the loopback API, `Mnemo.UI` and `mnemo-web` are presentation.
